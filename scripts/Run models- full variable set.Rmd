---
title: "Run Population Growth Rate models using full variable set"
output: 
  html_notebook: 
    fig_height: 15
    fig_width: 15
...
for(i in 1:nrow(modSumm_toRun)) {
    ...
    # diagnostic plot
    png(paste0("../figures/diagnostics/fullVariableSet/", gsub("/", "-", sp_i),".png"), width = 500, height=500)
...
```{r format&saveOutputs}
modSumm_toRun <- modSumm_toRun %>%
    mutate(var_quotient = sigma_full^2/sigma_null^2)

saveRDS(modSumm_toRun, "../files/model outputs/fullModels_explanatoryCapacity.rds")
...
saveRDS(coefs_full, "../files/model outputs/fullModels_coefs.rds")
...
saveRDS(spatial_full, "../files/model outputs/fullModels_explanatoryCapacity_spatial.rds")
```